...
require "rspec"
require "adulttime_dl/datastore_util/store_converter"

RSpec.describe AdultTimeDL::DataStoreUtil::StoreConverter, type: :file_support do
  ...
  describe ".export" do
    ...
    context "when store is an invalid file" do
      ...
      it "raises an error" do
        expect { out_file }.to raise_error(AdultTimeDL::FatalError)
      end
    end
  end
